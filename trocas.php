  ...
  <body>
    ...
    <main class="flex-fill">
      <div class="container">
        ...
        <hr>
        <p>
          A Amazon aceita a devolução de produtos físicos até 30 dias a partir da data de recebimento do pedido, com exceção de produtos comestíveis, cujo prazo para devolução é até 7 dias após a data de recebimento. 
