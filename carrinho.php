            ...
            <div class="row g-3">
              ...
              <div
                ...
                <div class="input-group">
                  ...
                  <span class="input-group-text">19,99</span>
                  <div class="text-end mt-2">
                    <button class="btn btn-outline-dark border-dark btn-sm" type="button" aria-label="⠀">
                      <i class="bi-trash" style="font-size: 20px; line-height: 20px;"></i>
                    </button>
                  </div>
                </div>
              </div>
            ...
            <div class="row g-3">
              ...
              <div
                ...
                <div class="input-group">
                  ...
                  <span class="input-group-text">€</span>
                  <span class="input-group-text">51,05</span>
                  <div class="text-end mt-2">
                    <button class="btn btn-outline-dark border-dark btn-sm" type="button" aria-label="⠀">
                      <i class="bi-trash" style="font-size: 20px; line-height: 20px;"></i>
                    </button>
            ...
            <div class="row g-3">
              ...
              <div
                ...
                <div class="input-group">
                  ...
                  <span class="input-group-text">€</span>
                  <span class="input-group-text">29,99</span>
                  <div class="text-end mt-2">
                    <button class="btn btn-outline-dark border-dark btn-sm" type="button" aria-label="⠀">
                      <i class="bi-trash" style="font-size: 20px; line-height: 20px;"></i>
                    </button>
            ...
            <div class="row g-3">
              ...
              <div
                ...
                <div class="input-group">
                  ...
                  <span class="input-group-text">€</span>
                  <span class="input-group-text">33,48</span>
                  <div class="text-end mt-2">
                    <button class="btn btn-outline-dark border-dark btn-sm" type="button" aria-label="⠀">
                      <i class="bi-trash" style="font-size: 20px; line-height: 20px;"></i>
                    </button>
            ...
            <div class="row g-3">
              ...
              <div
                ...
                <div class="input-group">
                  ...
                  <span class="input-group-text">€</span>
                  <span class="input-group-text">30,90</span>
                  <div class="text-end mt-2">
                    <button class="btn btn-outline-dark border-dark btn-sm" type="button" aria-label="⠀">
                      <i class="bi-trash" style="font-size: 20px; line-height: 20px;"></i>
                    </button>
              ...
              <li class="list-group-item py-3">
                <div class="text-end">
                  ...
                  <a href="index.php" class="btn btn-outline-dark btn-lg">Continuar a Comprar</a>
                  <a href="conclusao_itens.php" class="btn btn-dark btn-lg ms-2 mt-xs-3">Fechar a Compra</a>
                </div>
              </li>
