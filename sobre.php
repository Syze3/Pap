...
<meta name="theme-color" content="#ffffff">
    ...
    <title>Quem é a Amazon em Portugal</title>
    <style>
    body{
  ...
  <body>
    ...
    <main class="flex-fill">
      <div class="container">
          <h1>Sobre a Amazon em Portugal</h1>
          <hr>
          <p>
            A Amazon em Portugal é uma filial da Amazon. Este projeto foi idealizado para a realização da minha Prova de Aptidão Profissional (PAP).
          </p>
          <p>
            Para além das vendas online, irá existir uma loja física no centro do País (Leiria) com o intuito de dar uma resposta mais rápida e eficaz a todas as encomendas realizadas no site.
          </p>
      </div>
      ...
      <div class="container">
          ...
          <div class="row py-3">
              ...
              <div class="col-12 col-md-4 text-center">
                  ...
                  <a href="contacto.phpl" class="text-decoration-none text-dark">
                      Contacto Pelo Site
