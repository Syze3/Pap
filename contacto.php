...
<meta name="theme-color" content="#ffffff">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark border-bottom shadow-sm mb-3  ">
      <div class="container">
        <a class="navbar-brand" href="index.php"><b>Amazon Portugal</b></a>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <form action="col-sm-10 col-md-8 col-lg-6">
            ...
            <div class="form-floating mb-3">
              <textarea id="txtMensagem" class="form-control" placeholder="⠀" style="height:200px;"> Mensagem</textarea>

            <button type="button" onclick="window.location.href='confirmcontacto.php'" class="btn btn-lg btn-dark">Enviar Mensagem</button>
